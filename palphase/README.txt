PAL phase test program by Damian Yerrick
...
a signal relies on the TV to combine adjacent lines' chroma (hue and saturation) signals to produce the correct color.
...
Run it on a PowerPak, EverDrive-N8, inviteNES, or other NES
compatible flash card.
