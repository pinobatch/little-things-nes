...
SEGMENTS {
  ...
  BANK0:    load=ROM0, type=ro, align=$100, optional=yes, define=yes;
  BANK1:    load=ROM1, type=ro, align=$100, optional=yes, define=yes;
  BANK2:    load=ROM2, type=ro, align=$100, optional=yes, define=yes;
